...
export default function BuyerDashboard() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F7F2E9", color: "#2B2420" }}>
      ...
      {/* Main Content with responsive desktop sidebar offset */}
      <main className="buyer-main-content min-h-screen transition-all duration-300 px-4 md:px-8 py-8 pb-24 md:pb-8 max-w-7xl">
        {/* Welcome Header */}
        <div className="mb-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card
            ...
            style={{ borderColor: "#DDD3C0", background: "rgba(255,255,255,0.6)" }}
          >
          ...
          {/* Total Spent */}
          <Card
            className="border-2 rounded-2xl overflow-hidden sm:col-span-2 lg:col-span-1"
            style={{ borderColor: "#DDD3C0", background: "rgba(255,255,255,0.6)" }}
          >
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle
        ...
        <div className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/buyer/browse">
              <div
                className="rounded-2xl border-2 p-5 transition-all active:scale-[0.99] cursor-pointer"
                style={{ borderColor: "#DDD3C0", background: "#1E3A5F" }}
              >
          ...
          {isLoading ? (
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {availableProduce.slice(0, 6).map((produce) => (
                <Card
                  key={produce.id}
                  className="border-2 rounded-2xl overflow-hidden transition-all hover:border-[#1E3A5F]"
                  style={{ borderColor: "#DDD3C0", background: "#F7F2E9" }}
                >
                  <CardContent className="p-0">
                    ...
                    <div className="p-4">
                      ...
                      <Link href={`/buyer/browse/${produce.id}`}>
                        <button
                          className="mt-3 w-full h-10 rounded-xl text-sm font-bold transition-opacity active:scale-[0.99]"
