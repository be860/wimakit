        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="e.g., Rice, Cassava, Tomatoes" value={formData.name} onChange={(e) => handleChange("name", e.target.value)} required />
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="harvestDate" type="date" value={formData.harvestDate} onChange={(e) => handleChange("harvestDate", e.target.value)} required />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="quantity" type="number" placeholder="e.g., 500" value={formData.quantity} onChange={(e) => handleChange("quantity", e.target.value)} required />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="pricePerUnit" type="number" placeholder="e.g., 8000" value={formData.pricePerUnit} onChange={(e) => handleChange("pricePerUnit", e.target.value)} required />
            </div>

            <div className="space-y-2">
              <Label htmlFor="description">Description</Label>
              <Textarea id="description" placeholder="Describe your produce, quality, and any special details..." rows={4} value={formData.description} onChange={(e) => handleChange("description", e.target.value)} required />
            </div>
            ...
            <div className="flex gap-4">
              ...
              <Button type="button" variant="outline" onClick={() => router.push("/farmer/produce")} disabled={submitting}>
                Cancel
              </Button>
            </div>
          </form>
